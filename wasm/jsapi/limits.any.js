...
// increase timeout, in WPT only.
if (typeof setup === "function") {
  setup({timeout_multiplier: 100});
}
...
// FIXME(ssauleau): re-enable this test
testLimit.skip("element segments", 1, kJSEmbeddingMaxElementSegments, (builder, count) => {
